            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    while New_ball.y <= 600 and New_ball.x <= 1200 and (
                            (New_target.x - New_ball.x) ** 2 + (New_target.y - New_ball.y) ** 2) > (
                            (New_target.r + New_ball.r) ** 2) and (
                        ...
                        y_change += 1
                        if ((New_target.x - New_ball.x) ** 2 + (New_target.y - New_ball.y) ** 2) < (
                                (New_target.r + New_ball.r) ** 2):
                            count += 1
                            display_score(count)
                        elif ((New_target1.x + New_target1.l / 2 - New_ball.x) ** 2 + (
                                New_target1.y + New_target1.h / 2 - New_ball.y) ** 2) <= (
                                (int(math.sqrt(New_target1.l ** 2 + New_target1.h ** 2) / 2) + New_ball.r) ** 2):
                            count += 2
                    ...
                    while New_ball2.y <= 600 and New_ball2.x <= 1200 and (
                            ...
                            (New_target.r + New_ball2.r) ** 2) and (((
                                                                             New_target1.x + New_target1.l / 2 - New_ball2.x) ** 2 + (
                                                                             New_target1.y + New_target1.h / 2 - New_ball2.y) ** 2) > (
                                                                            (int(math.sqrt(
                                                                                New_target1.l ** 2 + New_target1.h ** 2) / 2) + New_ball2.r) ** 2)):
                        clock.tick(40)
                        ...
                        if ((New_target.x - New_ball2.x) ** 2 + (New_target.y - New_ball2.y) ** 2) < (
                            ...
                            count += 1
                            display_score(count)
                        elif ((New_target1.x + New_target1.l / 2 - New_ball2.x) ** 2 + (
                                New_target1.y + New_target1.h / 2 - New_ball2.y) ** 2) < (
